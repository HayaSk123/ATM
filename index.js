...
const pin = 12345;
console.log(chalk.red.bold("<-------  Welcome to Haya Sikander's ATM  ------->"));
...
async function handleDeposit() {
    ...
    if ((await promptYesNo("Would you like to check your current balance?")) ===
        "Yes") {
...
async function handleWithdrawal() {
    ...
    if (amount <= currentBalance) {
        ...
        if ((await promptYesNo("Would you like to apply for a loan?")) === "Yes") {
            ...
            console.log(chalk.green(`Your loan has been approved and your current balance is ${currentBalance}`));
            if (currentBalance >= amount &&
                (await promptYesNo("Would you like to continue your process of withdrawal?")) === "Yes") {
                currentBalance -= amount;
                console.log(chalk.green("Your withdrawal was successful"));
            }
            else {
